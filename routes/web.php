...
Route::group(['middleware' => 'guest'], function(){
    ...
    Route::get('/client/connexion', [AccountController::class, 'loginClient'])->name('client.login');
...
Route::post('/client/loginClient', [AccountController::class, 'clientAuthentification'])->name('client.authentification');
...
Route::group(['prefix' => 'admin','middleware' => 'checkRole'], function(){
    ...
    Route::delete('/client',[ClientController::class,'destroy'])->name('admin.destroyClient');
