@php
    $artisans = App\Models\MessageClient::where('user_id',Auth::user()->id)->get();
@endphp
...
<div class="card border-0 shadow mb-4 p-3">
    <div class="s-body text-center mt-3">
        ...
        <h5 class="mt-3 pb-0">{{$user->nom}} {{$user->prenom}}</h5>
    ...
    <div class="card-body p-0">
        <ul class="list-group list-group-flush ">
            <li class="list-group-item d-flex justify-content-between p-3">
                <a href="{{route('client.artisans')}}" class="{{ Request::is('client/artisans') ? 'active-link' : '' }}">Mes artisans <span class="badge rounded-pill bg-success">{{$artisans->count()}}</span></a>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                <a href="{{route('client.compte')}}" class="{{ Request::is('client/compte') ? 'active-link' : '' }}">Mon compte</a>
            </li>                                                     
        </ul>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title pb-0" id="exampleModalLabel">Ajouter une photo de profil</h5>
