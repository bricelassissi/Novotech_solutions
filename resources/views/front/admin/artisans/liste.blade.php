                            ...
                            <tbody>
                                ...
                                @foreach ($artisans as $artisan)
                                    ...
                                    {{-- class="view-btn pointer" --}}
                                        <td class="text-center view-btn pointer">{{ $counter }}</td>
                                        <td class="text-capitalize view-btn pointer">{{$artisan->user->nom}} {{$artisan->user->prenom}}</td>
                                        <td class="text-center view-btn pointer">{{$artisan->metier->metier}}</td>
                                        <td class="text-center view-btn pointer">{{dateFormat($artisan->created_at)}}</td>
