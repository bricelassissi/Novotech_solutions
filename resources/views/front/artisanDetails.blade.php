...
<section class="section-4 bg-2">    
    ...
    <div class="container job_details_area">
        ...
        <div class="row pb-5">
            ...
            @endif --}}
            @if (Auth::check() && (Auth::user()->type == 'Artisan' || Auth::user()->type == 'Admin'))
            <div class="col-md-12">
                @else
            <div class="col-md-8">
                ...
                <div class="card shadow border-0">
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            ...
                            @elseif(!Auth::check() || (Auth::check() && (Auth::user()->type != 'Artisan' && Auth::user()->type != 'Admin')))
                                <a href="{{route('client.login', ['artisanId'=>$artisan->id])}}" class="btn btn-danger">Connectez-vous pour envoyer un message à votre artisan</a>
                            @endif
                        </div>
                    </div>
                </div>
